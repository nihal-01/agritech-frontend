  ...
  return (
    <div className="notFoundPage__wrapper">
      <div className="notFoundPage">
        ...
        <h4 className="notFoundPage__title">oops, that link is broken.</h4>
        <p className="notFoundPage__desc">
          Page doesn't exist or some other error occured. Go to our{" "}
          <Link to="/">
            <button className="notFoundPage__desc__btn">Home page</button>
          </Link>{" "}
          or go back to{" "}
          <button className="notFoundPage__desc__btn" onClick={() => navigate(-1)}>
            Previous page
          </button>
        </p>
      </div>
